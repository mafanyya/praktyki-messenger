 ...
 */
final class Version20220905164447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP hobby');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD hobby VARCHAR(255) DEFAULT NULL');
    }
}
