...
";
    ...
    <div class=\"container\">
        <div class=\"container_inner\">
            <div class=\"main_inf\">
                <div class=\"avatar\">
                    <img src=\"";
        // line 17
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/avatars/" . (isset($context["avatar"]) || array_key_exists("avatar", $context) ? $context["avatar"] : (function () { throw new RuntimeError('Variable "avatar" does not exist.', 17, $this->source); })()))), "html", null, true);
        echo "\" alt=\"\">
                </div>
                <div class=\"user_inf\">
                    <p class = \"username\">";
        ...
        echo "</p>
                    ...
                    ";
        // line 22
        if ((((isset($context["isShowCredentials"]) || array_key_exists("isShowCredentials", $context) ? $context["isShowCredentials"] : (function () { throw new RuntimeError('Variable "isShowCredentials" does not exist.', 22, $this->source); })()) == true) || ((isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 22, $this->source); })()) == (isset($context["currentId"]) || array_key_exists("currentId", $context) ? $context["currentId"] : (function () { throw new RuntimeError('Variable "currentId" does not exist.', 22, $this->source); })())))) {
            // line 23
            echo "                    <div class=\"inf\">
            ...
            echo "</p>
                    ...
                    ";
            // line 26
            if ((isset($context["country"]) || array_key_exists("country", $context) ? $context["country"] : (function () { throw new RuntimeError('Variable "country" does not exist.', 26, $this->source); })())) {
                // line 27
                echo "                        <div class=\"inf\">
                            <p class = \"name\">";
                // line 28
            ...
            echo "
                    ...
                    ";
            // line 33
            if ((isset($context["hobbies"]) || array_key_exists("hobbies", $context) ? $context["hobbies"] : (function () { throw new RuntimeError('Variable "hobbies" does not exist.', 33, $this->source); })())) {
                // line 34
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["hobby"]) {
                    // line 36
                    echo "                                <p><i class=\"";
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["hobby"], "img", [], "any", false, false, false, 36), "html", null, true);
                    echo "\"></i> ";
...
";
    ...
    ";
        // line 61
        echo $this->extensions['Symfony\WebpackEncoreBundle\Twig\EntryFilesTwigExtension']->renderWebpackLinkTags("page");
        echo "
";
    ...
    ";
        // line 66
        echo $this->extensions['Symfony\WebpackEncoreBundle\Twig\EntryFilesTwigExtension']->renderWebpackScriptTags("page");
        echo "
";
    ...
    {
        return array (  279 => 66,  274 => 65,  264 => 64,  252 => 61,  247 => 60,  237 => 59,  224 => 56,  214 => 55,  192 => 41,  189 => 40,  185 => 38,  174 => 36,  170 => 35,  167 => 34,  165 => 33,  161 => 31,  155 => 28,  152 => 27,  150 => 26,  145 => 24,  142 => 23,  140 => 22,  135 => 20,  129 => 17,  119 => 11,  109 => 10,  96 => 7,  86 => 6,  73 => 3,  63 => 2,  40 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"container\">
        <div class=\"container_inner\">
            <div class=\"main_inf\">
                <div class=\"avatar\">
                    <img src=\"{{ asset('uploads/avatars/' ~  avatar ) }}\" alt=\"\">
                </div>
                <div class=\"user_inf\">
